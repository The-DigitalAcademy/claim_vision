...
def preprocess_data(df):
    ...
    # Fit the encoder after ensuring all columns are present
...
feature_names = ['Age', 'No_Pol','Gender', 'Car_Category', 'Subject_Car_Colour', 'Subject_Car_Make', 'LGA_Name', 'State', 'ProductName']
